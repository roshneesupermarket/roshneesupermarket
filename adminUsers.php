...
<section class="user-accounts">
   ...
   <div class="box-container">
      ...
      <div class="box" style="<?php if($fetch_users['id'] == $admin_id){ echo 'display:none'; }; ?>">
         <img src="customer_img/<?= $fetch_users['image']; ?>" alt="">
         ...
         <a href="adminUsers.php?delete=<?= $fetch_users['id']; ?>" onclick="return confirm('Delete this user?');" class="delete-btn">Delete</a>
      </div>
      <?php
      }
      ?>
